...
ifeq ($(OS), Darwin)
	...
	$(CC) $(CFLAGS) -o test unit_tests.c s21_decimal.a -lcheck -lrt -lpthread -lm -coverage
	./test
endif
...
ifeq ($(OS), Darwin)
	...
	$(CC) --coverage $(PROFILE_FLAGS) unit_tests.c s21_decimal.c -o test -lcheck -lrt -lpthread -lm
endif
	./test
